...
Every computational rule and legal prompt instruction is traceably linked to official Indonesian government gazettes and rulesets (`engines/rules/`).
...
| `BPJS-JP-2024` | PP 45/2015 & SE 2024 | Pasal 29 | `engines/bpjs-calculator.js` | [BPJS Ketenagakerjaan FAQ](https://faq-int.bpjsketenagakerjaan.go.id/) |
| `BPJS-JP-2025` | BPJS SE B/726/022025 | Surat Edaran | `engines/bpjs-calculator.js` | [BPJS Ketenagakerjaan FAQ](https://faq-int.bpjsketenagakerjaan.go.id/) |
| `BPJS-JP-2026` | BPJS SE B/3307/022026 | Surat Edaran | `engines/bpjs-calculator.js` | [BPJS Ketenagakerjaan FAQ](https://faq-int.bpjsketenagakerjaan.go.id/) |
