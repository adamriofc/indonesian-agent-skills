...
<p align="center">
  <img src="docs/indonesian-business-agent-skills-hero.svg?v=6.12.0" alt="Indonesian Business Agent Skills Banner" width="100%">
</p>
...
|---|---|---|
| **Repository Version** | `v6.12.0` | SemVer release boundary |
...
| **Total Test Assertions** | `514+` | Deepened matrix assertions across full `npm test` suite |
