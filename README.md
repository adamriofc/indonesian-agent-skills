...
<p align="center">
  <img src="docs/indonesian-business-agent-skills-hero.svg?v=6.13.0" alt="Indonesian Business Agent Skills Banner" width="100%">
</p>
...
|---|---|---|
| **Repository Version** | `v6.13.0` | SemVer release boundary |
